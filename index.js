...
// const newArray = CafeName.filter((e) => "place_id");
...
const newDetails=(cafe_name)=>{
    console.log(cafe_name)
    console.log(CafeName)
    const CafeName2 = CafeName.map((e,idx) = e.name)
    console.log(CafeName2)
    console.log(cafeDetails)
    CafeName.map((e,idx)=>{
     if(cafe_name ==e.name){
        console.log(e.place_id)
        cafeDetails.map((e2,idx)=>{
            if(e2.id == e.place_id){
                console.log(e2)
            }
        })
